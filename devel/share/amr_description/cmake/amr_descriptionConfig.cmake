...
if("TRUE" STREQUAL "TRUE")
  set(amr_description_SOURCE_PREFIX /home/jk/catkin_ws/src/amr_description)
  set(amr_description_DEVEL_PREFIX /home/jk/catkin_ws/devel)
  ...
  set(amr_description_INSTALL_PREFIX /home/jk/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer ' <zoonhe123456@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amr_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jk/catkin_ws/src/amr_description/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(amr_description_EXPORTED_TARGETS ${${amr_description_dep}_EXPORTED_TARGETS})
endforeach()
