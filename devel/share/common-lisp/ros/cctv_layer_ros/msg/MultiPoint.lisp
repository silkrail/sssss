...
(cl:defmethod cl:initialize-instance :after ((m <MultiPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cctv_layer_ros-msg:<MultiPoint> is deprecated: use cctv_layer_ros-msg:MultiPoint instead.")))
